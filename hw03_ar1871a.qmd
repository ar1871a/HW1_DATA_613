...
#5th: Renaming Columns Names and replacing --- with NA
df <- df |> 
  select(
    state_or_territory,
    ...
    percent_ec_2020,
    house_seats_b,
    pop_perelec_vote_2020_c,
    pop_perseat_2020_a
  ) |>
  rename(
    SoT = state_or_territory,
    Population = census_population_8_9_a_2,
    Percent_US = percent_us_2020,
    Percent_EC = percent_ec_2020,
    House_Seats = house_seats_b,
    Pop_per_elec_vote_2020 = pop_perelec_vote_2020_c,
    Pop_per_seat_2020 = pop_perseat_2020_a
  ) |> 
  ...
  mutate(
    ...
    Pop_per_elec_vote_2020 = as.numeric(str_remove_all(Pop_per_elec_vote_2020, ",")),
    Pop_per_seat_2020 = as.numeric(str_remove_all(Pop_per_seat_2020, ",")),
    House_Seats = as.numeric(House_Seats)
  )
